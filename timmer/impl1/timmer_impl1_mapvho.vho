...
-- ldbanno -n VHDL -o timmer_impl1_mapvho.vho -w -neg -gui timmer_impl1_map.ncd 
-- Netlist created on Thu May 10 11:28:24 2018
-- Netlist written on Thu May 10 11:28:28 2018
...
-- entity ccu20004
  ...
  begin
    inst1: CCU2D
      generic map (INIT0 => X"F000", INIT1 => X"5955", INJECT1_0 => "NO", 
                   INJECT1_1 => "NO")
      port map (CIN=>CI, A0=>A0, B0=>B0, C0=>C0, D0=>D0, A1=>A1, B1=>B1, 
                C1=>C1, D1=>D1, S0=>S0, S1=>S1, COUT=>CO1);
  end Structure;
...
-- entity SLICE_22
  ...
  begin
    ...
    cnt_shi_139_i1: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_shi_139_i0: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_23
  ...
  begin
    i649_3_lut_4_lut: lut40017
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i642_2_lut_3_lut: lut40018
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    cnt_shi_139_i3: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_shi_139_i2: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_24
  ...
  begin
    i5_4_lut: lut40019
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    hold_flag_I_0_1_lut_rep_27: lut40015
      port map (A=>A0_ipd, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    hold_flag_37: vmuxregsre0020
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_26
  ...
  begin
    i787_2_lut_rep_26: lut40023
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i144_2_lut_rep_24_3_lut_4_lut_4_lut: lut40024
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_29
  ...
  begin
    i2_4_lut_adj_7: lut40028
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i3_4_lut_adj_6: lut40029
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_33
  ...
  begin
    cnt_shi_3_bdd_4_lut: lut40035
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    mux_58_Mux_6_i15_3_lut_4_lut_4_lut: lut40036
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_34
  ...
  begin
    cnt_shi_0_bdd_4_lut: lut40037
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i527_4_lut_4_lut: lut40038
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_36
  ...
  begin
    i1_4_lut_4_lut_adj_5: lut40034
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    mux_58_Mux_5_i15_4_lut_4_lut: lut40041
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_38
  ...
  begin
    i843_4_lut_4_lut: lut40044
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i848_2_lut_4_lut: lut40045
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_39
  ...
  begin
    i826_3_lut_4_lut: lut40046
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1_4_lut_4_lut_adj_2: lut40047
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_40
  ...
  begin
    equal_71_i7_2_lut_2_lut_3_lut_4_lut: lut40021
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i846_4_lut: lut40033
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_42
  ...
  begin
    i1_4_lut_adj_4: lut40050
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    cnt_ge_3_bdd_4_lut: lut40051
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_43
  ...
  begin
    cnt_shi_3_bdd_4_lut_855: lut40052
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i14_4_lut: lut40053
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_44
  ...
  begin
    i819_3_lut_4_lut: lut40054
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i777_3_lut_4_lut: lut40055
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_45
  ...
  begin
    ...
    VitalBehavior : PROCESS (C0_ipd, B0_ipd, A0_ipd, F0_out, F1_out)
    VARIABLE F0_zd         	: std_logic := 'X';
    VARIABLE F0_GlitchData 	: VitalGlitchDataType;
...
-- entity xo2iobuf0058
  ...
  entity xo2iobuf0058 is
    port (Z: out Std_logic; PAD: in Std_logic);

    ATTRIBUTE Vital_Level0 OF xo2iobuf0058 : ENTITY IS TRUE;

  end xo2iobuf0058;

  architecture Structure of xo2iobuf0058 is
  begin
    INST1: IBPD
      port map (I=>PAD, O=>Z);
  end Structure;
...
-- entity clkB
  ...
  architecture Structure of clkB is
    ...
    component xo2iobuf0058
      port (Z: out Std_logic; PAD: in Std_logic);
    end component;
  begin
    clk_pad: xo2iobuf0058
  ...
  begin
    ...
    SLICE_15I: SLICE_15
      port map (A1=>cnt_2, A0=>cnt_1, DI1=>n123, DI0=>n124, LSR=>n670, 
                ...
                Q1=>cnt_2, FCO=>n1007);
    SLICE_16I: SLICE_16
      port map (D1=>cnt_shi_1, C1=>n1260, B1=>cnt_shi_0, A1=>n1, B0=>n8, 
                A0=>n867, FCI=>n1004, F0=>back_to_zero_flag_N_76_6, 
                F1=>back_to_zero_flag_N_76_7, FCO=>n1005);
    SLICE_17I: SLICE_17
      port map (A1=>cnt_0, DI1=>n125, LSR=>n670, CLK=>clk_c, F1=>n125, 
                Q1=>cnt_0, FCO=>n1006);
    SLICE_18I: SLICE_18
      port map (B1=>cnt_shi_3, A1=>cnt_shi_2, B0=>clk_divided, A0=>n70, 
                DI0=>clk_divided_N_71, LSR=>rst_c, CLK=>clk_c, 
                F0=>clk_divided_N_71, Q0=>clk_divided, F1=>n1260);
    SLICE_19I: SLICE_19
      port map (D1=>cnt_ge_1, C1=>cnt_ge_2, B1=>cnt_ge_0, A1=>cnt_ge_3, 
                D0=>cnt_ge_3, C0=>n1256, B0=>cnt_ge_0, A0=>hold_flag, 
                DI0=>n11_adj_6, LSR=>clk_divided_enable_7, CLK=>clk_divided, 
                F0=>n11_adj_6, Q0=>cnt_ge_0, F1=>seg_led_1_c_0);
    SLICE_20I: SLICE_20
      port map (C1=>cnt_ge_1, B1=>cnt_ge_0, A1=>cnt_ge_2, B0=>cnt_ge_1, 
                A0=>cnt_ge_0, DI1=>n363, DI0=>n6_adj_1, 
                CE=>clk_divided_enable_4, LSR=>clk_divided_enable_7, 
                CLK=>clk_divided, F0=>n6_adj_1, Q0=>cnt_ge_1, F1=>n363, 
                Q1=>cnt_ge_2);
    SLICE_21I: SLICE_21
      port map (D1=>cnt_ge_3, C1=>cnt_ge_0, B1=>cnt_ge_2, A1=>cnt_ge_1, 
                D0=>cnt_ge_1, C0=>cnt_ge_2, B0=>cnt_ge_0, A0=>cnt_ge_3, 
                DI0=>n362, CE=>clk_divided_enable_4, LSR=>clk_divided_enable_7, 
                CLK=>clk_divided, F0=>n362, Q0=>cnt_ge_3, 
                F1=>clk_divided_enable_7);
    SLICE_22I: SLICE_22
      port map (B1=>cnt_shi_1, A1=>cnt_shi_0, A0=>cnt_shi_0, DI1=>n6_adj_5, 
                DI0=>n1, CE=>clk_divided_enable_7, CLK=>clk_divided, F0=>n1, 
                Q0=>cnt_shi_0, F1=>n6_adj_5, Q1=>cnt_shi_1);
    SLICE_23I: SLICE_23
      port map (D1=>cnt_shi_3, C1=>cnt_shi_2, B1=>cnt_shi_1, A1=>cnt_shi_0, 
                C0=>cnt_shi_2, B0=>cnt_shi_1, A0=>cnt_shi_0, DI1=>n22, 
                DI0=>n23, CE=>clk_divided_enable_7, CLK=>clk_divided, F0=>n23, 
                Q0=>cnt_shi_2, F1=>n22, Q1=>cnt_shi_3);
    SLICE_24I: SLICE_24
      port map (D1=>back_to_zero_flag_N_76_7, C1=>back_to_zero_flag_N_76_4, 
                B1=>back_to_zero_flag_N_76_8, A1=>back_to_zero_flag_N_76_5, 
                A0=>hold_flag, DI0=>n1257, CLK=>hold_c, F0=>n1257, 
                Q0=>hold_flag, F1=>n13);
    SLICE_25I: SLICE_25
      port map (D1=>back_to_zero_flag_N_76_6, C1=>back_to_zero_flag_N_76_2, 
                B1=>back_to_zero_flag_N_76_3, A1=>back_to_zero_flag_N_76_1, 
                D0=>n14, C0=>n13, B0=>rst_c, A0=>cnt_ge_0, F0=>n47, F1=>n14);
    SLICE_26I: SLICE_26
      port map (B1=>cnt_ge_2, A1=>cnt_ge_1, D0=>cnt_ge_3, C0=>n1256, 
                B0=>cnt_ge_0, A0=>hold_flag, F0=>clk_divided_enable_4, 
                F1=>n1256);
    SLICE_27I: SLICE_27
      port map (D1=>n1023, C1=>cnt_22, B1=>cnt_23, A1=>cnt_21, B0=>n70, 
                A0=>rst_c, F0=>n670, F1=>n70);
    SLICE_28I: SLICE_28
      port map (D1=>n1028, C1=>cnt_17, B1=>cnt_16, A1=>cnt_15, D0=>n1024, 
                C0=>cnt_19, B0=>cnt_18, A0=>cnt_20, F0=>n1023, F1=>n1024);
    SLICE_29I: SLICE_29
      port map (D1=>n165, C1=>cnt_10, B1=>cnt_9, A1=>cnt_11, D0=>cnt_13, 
                C0=>n1025, B0=>cnt_12, A0=>cnt_14, F0=>n1028, F1=>n1025);
    SLICE_30I: SLICE_30
      port map (D1=>cnt_3, C1=>cnt_6, B1=>cnt_5, A1=>cnt_2, D0=>n12, C0=>cnt_7, 
                B0=>n11, A0=>cnt_8, F0=>n165, F1=>n12);
    SLICE_31I: SLICE_31
      port map (D1=>cnt_shi_2, C1=>cnt_shi_3, B1=>cnt_shi_1, A1=>cnt_shi_0, 
                D0=>cnt_shi_1, C0=>cnt_shi_0, B0=>cnt_shi_2, A0=>cnt_shi_3, 
                F0=>n7, F1=>n1248);
    SLICE_32I: SLICE_32
      port map (D1=>cnt_ge_1, C1=>cnt_ge_3, B1=>cnt_ge_2, A1=>cnt_ge_0, 
                D0=>cnt_ge_3, C0=>cnt_ge_0, B0=>cnt_ge_2, A0=>cnt_ge_1, 
                F0=>seg_led_1_c_2, F1=>seg_led_1_c_4);
    SLICE_33I: SLICE_33
      port map (D1=>cnt_shi_0, C1=>cnt_shi_1, B1=>cnt_shi_2, A1=>cnt_shi_3, 
                D0=>cnt_shi_0, C0=>cnt_shi_3, B0=>cnt_shi_2, A0=>cnt_shi_1, 
    ...
    SLICE_35I: SLICE_35
      port map (D1=>cnt_ge_2, C1=>cnt_ge_3, B1=>cnt_ge_1, A1=>cnt_ge_0, 
                D0=>cnt_ge_1, C0=>cnt_ge_2, B0=>cnt_ge_0, A0=>cnt_ge_3, 
                F0=>seg_led_1_c_5, F1=>seg_led_1_c_6);
    SLICE_36I: SLICE_36
      port map (D1=>cnt_shi_3, C1=>cnt_shi_0, B1=>cnt_shi_2, A1=>cnt_shi_1, 
                D0=>cnt_shi_3, C0=>cnt_shi_2, B0=>cnt_shi_1, A0=>cnt_shi_0, 
                F0=>seg_led_2_c_6, F1=>seg_led_2_c_2);
    SLICE_37I: SLICE_37
      port map (D1=>cnt_shi_2, C1=>cnt_shi_3, B1=>cnt_shi_0, A1=>cnt_shi_1, 
                D0=>cnt_shi_1, C0=>cnt_shi_3, B0=>cnt_shi_2, A0=>cnt_shi_0, 
                F0=>n4, F1=>n5_adj_7);
    SLICE_38I: SLICE_38
    ...
    SLICE_41I: SLICE_41
      port map (D1=>cnt_shi_1, C1=>cnt_shi_3, B1=>cnt_shi_0, A1=>cnt_shi_2, 
                D0=>cnt_shi_2, C0=>cnt_shi_3, B0=>cnt_shi_0, A0=>cnt_shi_1, 
                F0=>n7_adj_4, F1=>seg_led_2_c_0);
    SLICE_42I: SLICE_42
      port map (D1=>cnt_ge_0, C1=>cnt_ge_1, B1=>cnt_ge_3, A1=>cnt_ge_2, 
                D0=>cnt_ge_1, C0=>cnt_ge_2, B0=>cnt_ge_0, A0=>cnt_ge_3, 
                F0=>seg_led_1_c_3, F1=>seg_led_1_c_1);
    SLICE_43I: SLICE_43
      port map (D1=>cnt_shi_1, C1=>cnt_shi_2, B1=>cnt_shi_0, A1=>cnt_shi_3, 
                D0=>cnt_shi_1, C0=>cnt_shi_2, B0=>cnt_shi_3, A0=>cnt_shi_0, 
                F0=>n6, F1=>n1249);
    SLICE_44I: SLICE_44
      port map (D1=>cnt_shi_3, C1=>cnt_shi_2, B1=>cnt_shi_1, A1=>cnt_shi_0, 
                D0=>cnt_shi_0, C0=>cnt_shi_1, B0=>cnt_shi_2, A0=>cnt_shi_3, 
                F0=>n1140, F1=>n8);
    SLICE_45I: SLICE_45
      port map (C0=>cnt_1, B0=>cnt_0, A0=>cnt_4, F0=>n11, F1=>GND_net);
