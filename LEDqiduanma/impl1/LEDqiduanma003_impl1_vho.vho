...
-- ldbanno -n VHDL -o LEDqiduanma003_impl1_vho.vho -w -neg -gui LEDqiduanma003_impl1.ncd 
-- Netlist created on Tue May 01 20:52:47 2018
-- Netlist written on Tue May 01 20:52:59 2018
...
-- entity SLICE_2
  ...
  begin
    seg_data_2_c_0_bdd_4_lut_233: lut40004
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    seg_data_2_c_3_bdd_4_lut: lut40005
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_3
  ...
  begin
    seg_data_2_c_1_bdd_4_lut: lut40006
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    mux_9_Mux_0_i15_4_lut: lut40007
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_4
  ...
  begin
    i232_4_lut: lut40008
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    seg_data_2_c_0_bdd_4_lut: lut40009
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_5
  ...
  begin
    seg_data_1_c_0_bdd_4_lut: lut40010
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    seg_data_1_c_1_bdd_4_lut: lut40011
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_6
  ...
  begin
    i225_4_lut: lut40012
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    seg_data_2_c_2_bdd_4_lut: lut40013
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
  ...
  begin
    SLICE_0I: SLICE_0
      port map (D1=>seg_data_1_c_1, C1=>seg_data_1_c_3, B1=>seg_data_1_c_2, 
                A1=>seg_data_1_c_0, D0=>seg_data_1_c_1, C0=>seg_data_1_c_3, 
                B0=>seg_data_1_c_2, A0=>seg_data_1_c_0, F0=>seg_led_1_c_0, 
                F1=>seg_led_1_c_2);
    SLICE_1I: SLICE_1
      port map (D1=>seg_data_1_c_2, C1=>seg_data_1_c_1, B1=>seg_data_1_c_3, 
                A1=>seg_data_1_c_0, D0=>seg_data_1_c_2, C0=>seg_data_1_c_1, 
                B0=>seg_data_1_c_3, A0=>seg_data_1_c_0, F0=>seg_led_1_c_1, 
                F1=>seg_led_1_c_3);
    SLICE_2I: SLICE_2
      port map (D1=>seg_data_2_c_0, C1=>seg_data_2_c_3, B1=>seg_data_2_c_1, 
                A1=>seg_data_2_c_2, D0=>seg_data_2_c_0, C0=>seg_data_2_c_3, 
                B0=>seg_data_2_c_1, A0=>seg_data_2_c_2, F0=>seg_led_2_c_3, 
                F1=>seg_led_2_c_5);
    SLICE_3I: SLICE_3
      port map (D1=>seg_data_2_c_3, C1=>seg_data_2_c_2, B1=>seg_data_2_c_1, 
                A1=>seg_data_2_c_0, D0=>seg_data_2_c_3, C0=>seg_data_2_c_2, 
                B0=>seg_data_2_c_1, A0=>seg_data_2_c_0, F0=>seg_led_2_c_0, 
                F1=>seg_led_2_c_6);
    SLICE_4I: SLICE_4
      port map (D1=>seg_data_2_c_3, C1=>seg_data_2_c_2, B1=>seg_data_2_c_1, 
                A1=>seg_data_2_c_0, D0=>seg_data_2_c_3, C0=>seg_data_2_c_2, 
                B0=>seg_data_2_c_1, A0=>seg_data_2_c_0, F0=>seg_led_2_c_1, 
                F1=>seg_led_2_c_4);
    SLICE_5I: SLICE_5
      port map (D1=>seg_data_1_c_0, C1=>seg_data_1_c_2, B1=>seg_data_1_c_1, 
                A1=>seg_data_1_c_3, D0=>seg_data_1_c_0, C0=>seg_data_1_c_2, 
                B0=>seg_data_1_c_1, A0=>seg_data_1_c_3, F0=>seg_led_1_c_6, 
                F1=>seg_led_1_c_5);
    SLICE_6I: SLICE_6
      port map (D1=>seg_data_1_c_3, C1=>seg_data_1_c_0, B1=>seg_data_1_c_2, 
                A1=>seg_data_1_c_1, D0=>seg_data_2_c_2, C0=>seg_data_2_c_3, 
                B0=>seg_data_2_c_1, A0=>seg_data_2_c_0, F0=>seg_led_2_c_2, 
                F1=>seg_led_1_c_4);
    SLICE_7I: SLICE_7
      port map (F0=>GND_net);
